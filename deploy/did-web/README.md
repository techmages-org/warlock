...
| DID | Serve at | File |
|---|---|---|
| `did:web:id.titaniumcomputing.com` (principal) | `https://id.titaniumcomputing.com/.well-known/did.json` | `id.titaniumcomputing.com/.well-known/did.json` |
| `did:web:decks.titaniumcomputing.com:warlock-cm5-01` (console) | `https://decks.titaniumcomputing.com/warlock-cm5-01/did.json` | `decks.titaniumcomputing.com/warlock-cm5-01/did.json` |
...
- point `id.titaniumcomputing.com` at the `id.titaniumcomputing.com/` dir
- point `decks.titaniumcomputing.com` at the `decks.titaniumcomputing.com/` dir
...
curl -s https://id.titaniumcomputing.com/.well-known/did.json | jq .id
curl -s https://decks.titaniumcomputing.com/warlock-cm5-01/did.json | jq .id
